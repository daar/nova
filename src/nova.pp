...
begin
  ...
  try
    ...
    FPCLines.Add('# FPC Configuration File (auto-generated by nova)');
    FPCLines.Add('# Generated on: ' + DateTimeToStr(Now));
    FPCLines.Add('# WARNING: Do not edit manually. Changes may be overwritten by nova.');
    FPCLines.Add('');
  ...
  //        PathDelim, [rfReplaceAll]);
  //      DepFile := DepPath + PathDelim + DEP_FILE;
  ...
  //        subPkgFile := p + PathDelim + DEP_FILE;
  //        if FileExists(subPkgFile) then
  //        begin
  //          writeln('Found nested ', DEP_FILE, ' in ', pathVal, ', installing dependencies...');
